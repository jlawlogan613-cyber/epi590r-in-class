...
format:
  html:
    ...
    fontcolor: "navy" # Added so text remains readable on an indigo background
    mainfont: sans-serif # Sets the document font family
execute:
  echo: false
---
...
*These tables may not show full accurate data 
